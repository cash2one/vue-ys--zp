<template>
        <span class="col-xs-n" :style="clsObj">
        {{diff}}
        </span>
</template>
<script>
    ...
    computed: {
      ...
      diff:function () {
        if(this.firstNum<this.secondNum){
          return '+'+(this.secondNum-this.firstNum).toFixed(2);
      ...
      nub:function () {
        if(this.firstNum<this.secondNum){
          return 'rgba(246,100,96,'+(((this.secondNum-this.firstNum)/this.secondNum)+0.1).toFixed(1)+')';
        }else if(this.firstNum==this.secondNum){
          return 'rgba(246,100,96,0)';
        }else {
          return 'rgba(75,201,179,'+(((this.firstNum-this.secondNum)/this.secondNum)+0.1).toFixed(1)+')';
        }
