...
<script>
    ...
    function ajx() {
      ...
      $('.s1').text(s);
      $('.s2').text(e);
      utils.ajax(apiUrl.getApiUrl('planvs'), {
        ...
        console.log(data);
        data.voAccountCom.oneView=-data.voAccountCom.oneView
        data.voAccountCom.oneTotalCpd=-data.voAccountCom.oneTotalCpd
        data.voAccountCom.oneTotalCpc=-data.voAccountCom.oneTotalCpc
        data.voAccountCom.oneTotalCpa=-data.voAccountCom.oneTotalCpa
        data.voAccountCom.oneDown=-data.voAccountCom.oneDown
        data.voAccountCom.oneCost=-data.voAccountCom.oneCost
        data.voAccountCom.oneClick=-data.voAccountCom.oneClick
        data.voAccountCom.oneActive=-data.voAccountCom.oneActive
        bili(data.voAccountCom);
