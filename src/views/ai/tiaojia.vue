    ...
    <el-row style="padding-right: 15px;padding-left: 15px;margin-top: 30px;">
                ...
                <div class="col-xs-12 gailan-zhi" id="users">
                    <div class="col-xs-12 clear" style="margin-top: 30px;">
                        <el-col :span="10" class="col-xs-5" style="padding-left: 0;">
                            全账户计划<button class="add">一键设置</button>
                        </el-col>
                    ...
                    <div class="col-xs-12 contain" style="margin-top: 30px;" id="tb">
                        <el-table
                            ...
                            <el-table-column
                                    ...
                                    width="150">
                                <template scope="scope">
                                    <div v-if="scope.row.auto=='off'">
                                        <input type="checkbox" :id="scope.row.campaignId" class="chk_3" style="display: none;" :data-id="scope.row.campaignId "/><label :for="scope.row.campaignId" style="margin-bottom: 0;"></label>
                                        <span>关闭</span>
                                    </div>
                                    <div v-else>
                                        <input type="checkbox" :id="scope.row.campaignId" class="chk_3" checked style="display: none;" :data-id="scope.row.campaignId"/><label :for="scope.row.campaignId" style="margin-bottom: 0;"></label>
                                        <span>开启</span>
                                    </div>
                                </template>
                            </el-table-column>
        ...
        <div class="beizhao">
            <div class="changed">
                ...
                <!--  <div class="col-xs-12" style="font-size: 12px;color: #3b4e61;margin-top: 30px;">
...
//               value1:getDateStr(-2),
      ...
      mounted:function(){
        ...
        $(document).on('change','#ck',function () {
          ...
          $('.gailan-toubiao').html('<a href="#" >全部计划</a>');
...
//            console.log(response);
        ...
        $(document).on('click','.jn',function () {
          ...
          console.log(dan);
//          store.setDan(dan);
//          this.$router.push({ path: '/ai/tiaojiaunit' });
          window.location.href='//localhost:9527/#/ai/tiaojiaunit';
//              window.location.href='/ai/tiaojiaunit';
        })
